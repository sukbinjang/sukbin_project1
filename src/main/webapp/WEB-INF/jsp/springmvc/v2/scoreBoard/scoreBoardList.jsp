...
<main>
    ...
    <div class="list rankingPlayer">
        ...
        <div class="tableColumn">score1</div>
        <div class="tableColumn">score2</div>
        <div class="tableColumn">date</div>

        <c:forEach var="match" items="${scoreBoardList}">
            <div class="item1">${match.result}</div>
            <div class="item2">${match.score1}</div>
            <div class="item2">${match.score2}</div>
            <div class="item2">${match.matchDate}</div>
        </c:forEach>
    </div>
</main>
